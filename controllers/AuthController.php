...
class AuthController extends Controller
{
    ...
    public function actionLogin(): array
    {
        ...
        if (!AuthenticationRepository::can($user->id, Constants::AUTHENTICATION_ADMINISTRATOR) && $user->ip_address != Utilities::getIp()) {
            throw new UnauthorizedHttpException('You cannot log in because your IP address is not active.');
        }
